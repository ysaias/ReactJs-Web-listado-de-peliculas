        ...
        <div className="login-content">
          ...
          <form method="post" action="#">
            <div className="row">
              <label for="username">
                Username:
                <input type="text" name="username" id="username" placeholder="Hugh Jackman" pattern="^[a-zA-Z][a-zA-Z0-9-_\.]{8,20}$" required="required"  autoComplete="on"/>
              </label>
            </div>
            ...
            <div className="row">
              <label for="password">
                Password:
                <input type="password" name="password" id="password" placeholder="******" pattern="(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$" required="required" autoComplete="off" />
              </label>
            </div>
            <div className="row">
          ...
          <form method="post" action="#">
            <div className="row">
              <label for="username-2">
                Username:
                <input type="text" name="username" id="username-2" placeholder="Hugh Jackman" pattern="^[a-zA-Z][a-zA-Z0-9-_\.]{8,20}$" required="required" autoComplete="on" />
              </label>
            </div>
            ...
            <div className="row">
              <label for="email-2">
                your email:
                <input type="password" name="email" id="email-2" placeholder="" pattern="(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$" required="required" autoComplete="on" />
              </label>
            </div>
            <div className="row">
            ...
            <div className="collapse navbar-collapse flex-parent" id="bs-example-navbar-collapse-1">
              <ul className="nav navbar-nav flex-child-menu menu-left">
                ...
                <li className="dropdown first">
                  ...
                  <ul className="dropdown-menu level1" target="_blank">
              ...
              <ul className="nav navbar-nav flex-child-menu menu-right">
                ...
                <li><a href="# ">Help</a></li>
                <li className="logina"><a href="# ">LOG In</a></li>
                <li className="btn signupa"><a href="# ">sign up</a></li>
              </ul>
            </div>
          </nav>
            ...
            <div className="col-md-4 col-sm-12 col-xs-12">
              <div className="sidebar">
                ...
                <div className="sb-facebook sb-it">
                  ...
                  <iframe src="#" data-src="https://www.facebook.com/plugins/page.php?to=https%3A%2F%2Fwww.facebook.com%2Ftemplatespoint.net%2F%3Ffref%3Dts&tabs=timeline&width=340&height=315px&small_header=true&adapt_container_width=false&hide_cover=false&show_facepile=true&appId" height="315" title='facebook'></iframe>
                </div>
